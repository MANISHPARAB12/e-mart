        ...
        <>
            <section className="services">
                <div className="text-container">
                        ...
                        <p>Since 2007 we have been delivering in product development, support & updates for frictionless shopping experiences</p>
                </div>

                <div className="servicecard-container">
                    <div className="servicecard vouchers">
                        <div className="text-container1">
                            <h3>Gromuse <br/> Gift vouchers.</h3>
                        </div>
                    ...
                    <div className="servicecard">
                        <div className="text-container1">
                            <h3>Pay your <br/>tabby invoice</h3>
                        </div>
                        <div className="img-container">
